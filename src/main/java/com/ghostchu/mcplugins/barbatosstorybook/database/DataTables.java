...
public enum DataTables {
    ...
    DATA("data", (table) -> {
        ...
        table.addColumn("author", "VARCHAR(128) NOT NULL");
        table.addColumn("item", "MEDIUMTEXT NOT NULL");
        table.addColumn("title", "TEXT");
        table.addColumn("content", "MEDIUMTEXT NOT NULL");
        table.addColumn("time", "timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP");
        table.addColumn("server", "VARCHAR(255) NOT NULL");
        //table.setIndex(IndexType.INDEX, "idx_title", "title");
    });
